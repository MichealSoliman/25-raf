            ...
            <div className="space-y-8">
              <div className="space-y-4 backdrop-blur-md bg-white/10 p-8 rounded-2xl border border-white/20">
                <h1 className="text-2xl lg:text-4xl font-light text-white leading-tight flex flex-col space-y-2">
                  ...
                  <span className="text-xl text-white/90 font-light">{}</span>
          ...
          <div className="backdrop-blur-md bg-white/10 rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="name" className="text-white my-2 flex items-center gap-2">
                ...
                <div>
                  <Label htmlFor="phone" className="text-white my-2 flex items-center gap-2">
              ...
              {/* Additional Notes */}
              <div>
                <Label htmlFor="notes" className="text-white my-2">
              ...
              <div className="pt-4">
                <Button
                  ...
                  className="w-full text-white px-8 py-4 text-lg rounded-xl transition-all duration-300 hover:shadow-lg hover:transform hover:-translate-y-1"
